...
var (
	md_MsgEcho      protoreflect.MessageDescriptor
	fd_MsgEcho_echo protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_counter_v1_tx_proto_init()
	md_MsgEcho = File_cosmos_counter_v1_tx_proto.Messages().ByName("MsgEcho")
	fd_MsgEcho_echo = md_MsgEcho.Fields().ByName("echo")
}

var _ protoreflect.Message = (*fastReflection_MsgEcho)(nil)

type fastReflection_MsgEcho MsgEcho

func (x *MsgEcho) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgEcho)(x)
}

func (x *MsgEcho) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_counter_v1_tx_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgEcho_messageType fastReflection_MsgEcho_messageType
var _ protoreflect.MessageType = fastReflection_MsgEcho_messageType{}

type fastReflection_MsgEcho_messageType struct{}

func (x fastReflection_MsgEcho_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgEcho)(nil)
}
func (x fastReflection_MsgEcho_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgEcho)
}
func (x fastReflection_MsgEcho_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEcho
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgEcho) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEcho
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgEcho) Type() protoreflect.MessageType {
	return _fastReflection_MsgEcho_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgEcho) New() protoreflect.Message {
	return new(fastReflection_MsgEcho)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgEcho) Interface() protoreflect.ProtoMessage {
	return (*MsgEcho)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgEcho) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Echo != "" {
		value := protoreflect.ValueOfString(x.Echo)
		if !f(fd_MsgEcho_echo, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgEcho) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
		return x.Echo != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.counter.v1.MsgEcho"))
		}
		panic(fmt.Errorf("message cosmos.counter.v1.MsgEcho does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEcho) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
		x.Echo = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgEcho) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
		value := x.Echo
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.counter.v1.MsgEcho does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEcho) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEcho) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
		panic(fmt.Errorf("field echo of message cosmos.counter.v1.MsgEcho is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.counter.v1.MsgEcho"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgEcho) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEcho.echo":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgEcho) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.counter.v1.MsgEcho", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgEcho) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEcho) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgEcho) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgEcho) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgEcho)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEcho: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEcho: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgEchoResponse      protoreflect.MessageDescriptor
	fd_MsgEchoResponse_echo protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_counter_v1_tx_proto_init()
	md_MsgEchoResponse = File_cosmos_counter_v1_tx_proto.Messages().ByName("MsgEchoResponse")
	fd_MsgEchoResponse_echo = md_MsgEchoResponse.Fields().ByName("echo")
}

var _ protoreflect.Message = (*fastReflection_MsgEchoResponse)(nil)

type fastReflection_MsgEchoResponse MsgEchoResponse

func (x *MsgEchoResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgEchoResponse)(x)
}

func (x *MsgEchoResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_counter_v1_tx_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MsgEchoResponse_messageType fastReflection_MsgEchoResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgEchoResponse_messageType{}

type fastReflection_MsgEchoResponse_messageType struct{}

func (x fastReflection_MsgEchoResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgEchoResponse)(nil)
}
func (x fastReflection_MsgEchoResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgEchoResponse)
}
func (x fastReflection_MsgEchoResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEchoResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgEchoResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgEchoResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgEchoResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgEchoResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgEchoResponse) New() protoreflect.Message {
	return new(fastReflection_MsgEchoResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgEchoResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgEchoResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgEchoResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Echo != "" {
		value := protoreflect.ValueOfString(x.Echo)
		if !f(fd_MsgEchoResponse_echo, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgEchoResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		return x.Echo != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.counter.v1.MsgEchoResponse"))
		}
		panic(fmt.Errorf("message cosmos.counter.v1.MsgEchoResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEchoResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		x.Echo = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgEchoResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		value := x.Echo
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.counter.v1.MsgEchoResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEchoResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		x.Echo = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEchoResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		panic(fmt.Errorf("field echo of message cosmos.counter.v1.MsgEchoResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.counter.v1.MsgEchoResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgEchoResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.counter.v1.MsgEchoResponse.echo":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgEchoResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.counter.v1.MsgEchoResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgEchoResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgEchoResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgEchoResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgEchoResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgEchoResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEchoResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgEchoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (*MsgEcho) Descriptor() ([]byte, []int) {
	return file_cosmos_counter_v1_tx_proto_rawDescGZIP(), []int{2}
}

func (x *MsgEcho) GetEcho() string {
	if x != nil {
		return x.Echo
	}
	return ""
...
func (x *MsgEchoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgEchoResponse) ProtoMessage() {}

// Deprecated: Use MsgEchoResponse.ProtoReflect.Descriptor instead.
func (*MsgEchoResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_counter_v1_tx_proto_rawDescGZIP(), []int{3}
}

func (x *MsgEchoResponse) GetEcho() string {
	if x != nil {
		return x.Echo
	}
	return ""
...
var file_cosmos_counter_v1_tx_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x1d, 0x0a, 0x07, 0x4d,
	0x73, 0x67, 0x45, 0x63, 0x68, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x63, 0x68, 0x6f, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x65, 0x63, 0x68, 0x6f, 0x22, 0x25, 0x0a, 0x0f, 0x4d, 0x73,
	0x67, 0x45, 0x63, 0x68, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a,
	0x04, 0x65, 0x63, 0x68, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x65, 0x63, 0x68,
	0x6f, 0x32, 0xb9, 0x01, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x63, 0x0a, 0x0d, 0x49, 0x6e, 0x63,
	...
	,
...
var file_cosmos_counter_v1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cosmos_counter_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgEcho)(nil),                  // 2: cosmos.counter.v1.MsgEcho
	(*MsgEchoResponse)(nil),          // 3: cosmos.counter.v1.MsgEchoResponse
}
var file_cosmos_counter_v1_tx_proto_depIdxs = []int32{
	...
	2, // 1: cosmos.counter.v1.Msg.Echo:input_type -> cosmos.counter.v1.MsgEcho
	1, // 2: cosmos.counter.v1.Msg.IncreaseCount:output_type -> cosmos.counter.v1.MsgIncreaseCountResponse
	3, // 3: cosmos.counter.v1.Msg.Echo:output_type -> cosmos.counter.v1.MsgEchoResponse
...
func file_cosmos_counter_v1_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_counter_v1_tx_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_counter_v1_tx_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgEchoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
