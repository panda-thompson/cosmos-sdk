...
func NewSingleHostTestnetCmdInitializer(execBinary string, workDir string, chainID string, outputDir string, initialNodesCount int, minGasPrice string, commitTimeout time.Duration, log func(string)) *SingleHostTestnetCmdInitializer {
